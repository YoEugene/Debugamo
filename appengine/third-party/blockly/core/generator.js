 ...
 */
Blockly.Generator.prototype.prefixLines = function(prefix, indent) {
  return indent + prefix.replace(/(?!\n$)\n/g, '\n' + indent);
};


/**
 * Append a common suffix onto each line of code.
 * @param {string} text The lines of code.
 * @param {string} suffix The common suffix.
 * @return {string} The suffixed lines of code.
 */
Blockly.Generator.prototype.suffixLines = function(suffix, indent) {
  return indent + suffix.replace(/(?!\n$)\n/g, '\n' + indent);
};
...
Blockly.Generator.prototype.addLoopTrap = function(branch, id) {
  ...
  if (this.STATEMENT_SUFFIX) {
    branch += this.suffixLines(this.STATEMENT_SUFFIX.replace(/%1/g,
        '\'' + id + '\''), this.INDENT);
  }
  return branch;
};
