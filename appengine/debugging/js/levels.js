...
Levels = [
    ...
    {   
        ...
        missionGuideDescription: [
            "迪摩：Ok, 看來這裡需要清理一下，把東西放到該放的位置。", 
            "迪摩：透過「拿起」積木我可以將地上的東西拿起，移動到另一個地方，再用「放下」積木來放下那個東西。", 
            "迪摩：呼叫主人～<br>請幫我修改錯誤的積木，讓我能將<span class='uk-text-primary'>小狗移到籃子裡頭</span>，再把<span class='uk-text-primary'>黏液移到桶子裡頭</span>。"
        ],
